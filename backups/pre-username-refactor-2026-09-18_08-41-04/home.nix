...
home.file.".local/bin/yayyy".source = config.lib.file.mkOutOfStoreSymlink "/home/suupatruupa/.nixos/local-bin/yayyy";
  ...
  xdg.configFile = {
    ...
    "alacritty".source      = config.lib.file.mkOutOfStoreSymlink "/home/suupatruupa/.nixos/.config/alacritty";
    "wezterm".source        = config.lib.file.mkOutOfStoreSymlink "/home/suupatruupa/.nixos/.config/wezterm";
    "gh".source             = config.lib.file.mkOutOfStoreSymlink "/home/suupatruupa/.nixos/.config/gh";
    "github-copilot".source = config.lib.file.mkOutOfStoreSymlink "/home/suupatruupa/.nixos/.config/github-copilot";
    "xsettingsd".source     = config.lib.file.mkOutOfStoreSymlink "/home/suupatruupa/.nixos/.config/xsettingsd";
    "kdeconnect".source     = config.lib.file.mkOutOfStoreSymlink "/home/suupatruupa/.nixos/.config/kdeconnect";
    "quickshell".source     = config.lib.file.mkOutOfStoreSymlink "/home/suupatruupa/.nixos/.config/quickshell";
    "Vibeshell".source      = config.lib.file.mkOutOfStoreSymlink "/home/suupatruupa/.nixos/.config/Vibeshell";
    "tinted-theming".source = config.lib.file.mkOutOfStoreSymlink "/home/suupatruupa/.nixos/.config/tinted-theming";
    "wallust".source        = config.lib.file.mkOutOfStoreSymlink "/home/suupatruupa/.nixos/.config/wallust";
    "mpv".source            = config.lib.file.mkOutOfStoreSymlink "/home/suupatruupa/.nixos/.config/mpv";
    "obsidian".source       = config.lib.file.mkOutOfStoreSymlink "/home/suupatruupa/.nixos/.config/obsidian";
    "starship.toml".source  = config.lib.file.mkOutOfStoreSymlink "/home/suupatruupa/.nixos/.config/starship.toml";
    "fuzzel".source         = config.lib.file.mkOutOfStoreSymlink "/home/suupatruupa/.nixos/.config/fuzzel";
    "nwg-look".source       = config.lib.file.mkOutOfStoreSymlink "/home/suupatruupa/.nixos/.config/nwg-look";
    "superfile".source      = config.lib.file.mkOutOfStoreSymlink "/home/suupatruupa/.nixos/.config/superfile";
    "bluetuith".source      = config.lib.file.mkOutOfStoreSymlink "/home/suupatruupa/.nixos/.config/bluetuith";
    "croc".source           = config.lib.file.mkOutOfStoreSymlink "/home/suupatruupa/.nixos/.config/croc";
  };
