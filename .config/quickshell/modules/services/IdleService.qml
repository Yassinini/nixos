...
Singleton {
    ...
    property string lockCmd: Config.system.idle.general.lock_cmd ?? "vibeshell-safe-lock"
    property string beforeSleepCmd: Config.system.idle.general.before_sleep_cmd ?? "vibeshell-safe-lock"
    property string afterSleepCmd: Config.system.idle.general.after_sleep_cmd ?? "vibeshell screen on"
